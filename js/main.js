...
function loop(ts){
  ...
  drawBackground();drawGroundLayer();drawObstacles();drawSouls();ctx.save();ctx.translate(sx,sy);drawSlashes();drawOrbs();drawScythes();drawLanterna();drawProjectiles();drawEnemyProjectiles();drawEnemies();drawPlayer();drawParticles();drawDamageTexts();ctx.restore();drawVignette();drawBossHealthBar();drawBanner();
}
